/**
 * ParametrosDocRepository.java Fecha de creación: 10 mar. 2022, 16:44:41 Copyright (c)
 ...
 */
@Repository
public interface ParametrosDocRepository extends JpaRepository<ParametrosDoc, Integer> {
