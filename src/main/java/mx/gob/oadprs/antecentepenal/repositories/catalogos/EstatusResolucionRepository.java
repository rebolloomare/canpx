/**
 * EstatusResolucionRepository.java Fecha de creación: 10 mar. 2022, 16:41:04 Copyright (c)
 ...
 */
@Repository
public interface EstatusResolucionRepository
	extends JpaRepository<EstatusResolucion, Integer> {
