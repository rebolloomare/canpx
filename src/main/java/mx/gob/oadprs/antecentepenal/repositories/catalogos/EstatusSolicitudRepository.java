/**
 * EstatusSolicitudRepository.java Fecha de creación: 10 mar. 2022, 16:42:04 Copyright (c)
 ...
 */
@Repository
public interface EstatusSolicitudRepository extends JpaRepository<EstatusSolicitud, Integer> {
